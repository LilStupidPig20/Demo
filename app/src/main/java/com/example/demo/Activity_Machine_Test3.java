...
public class Activity_Machine_Test3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_test3);
        ...
        buttonApply.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(radioId == R.id.radioButton1) {
                    ...
                    textView.setText("Вы выбрали верный ответ неверный ответ. Правильный ответ один раз в 2-3 месяца");
                }
            }
