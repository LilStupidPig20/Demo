...
public class Activity_Machine_Test2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_test2);
        ...
        buttonApply.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(radioId == R.id.radioButton3) {
                    ...
                    textView.setText("Вы выбрали верный ответ неверный ответ. Правильный ответ темпер");
                }
            }
